...
const x = {
  modal_1: {
    ...
    modli1: 'Back End Dev',
    modli2: '2015',
    modpara2: ' Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem excepturi cupiditate placeat suscipit quia consequuntur reprehenderit sit fuga officiis cupiditate optio dolore labore vero itaque adipisci nihil ipsam, quisquam, quasi officia dolorem consectetur. Modi, adipisci.',
    modli3: 'html',
    modli4: 'css',
    modli5: 'javascript',
    backGround: 'img/25.png',
    linkLive: 'https://abenezerassefa.github.io/',
    linkSrc: 'https://github.com/AbenezerAssefa',
  },
  modal_2: {
...
function dataFeeder(num) {
  if (num === 1) {
    ...
    mobileLive.setAttribute('onclick', "window.location.href='https://abenezerassefa.github.io/';");
    mobileSrc.setAttribute('onclick', "window.location.href='https://github.com/AbenezerAssefa';");
...
function deskFeeder(num) {
  if (num === 5) {
    ...
    deskLive.setAttribute('onclick', "window.location.href='https://abenezerassefa.github.io/';");
    deskSrc.setAttribute('onclick', "window.location.href='https://github.com/AbenezerAssefa';");
    ...
    deskLive.setAttribute('onclick', "window.location.href='https://https://abenezerassefa.github.io/';");
    deskSrc.setAttribute('onclick', "window.location.href='https://github.com/AbenezerAssefa';");
